...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", {year: year, title: "Welcome to the Band Generator"});
});
...
app.post("/submit", (req, res) => {
  ...
  let ranNum1 = Math.floor(Math.random() * adj.length);
  let ranNum2 = Math.floor(Math.random() * noun.length);

  let bandTitle = adj[ranNum1] + " " + noun[ranNum2];

  res.render("index.ejs", {year: year, title: bandTitle});
});
